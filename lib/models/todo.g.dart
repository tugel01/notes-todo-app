...
void _todoSerialize(
  ...
  writer.writeBool(offsets[1], object.taskDone);
}
...
Todo _todoDeserialize(
  ...
  object.taskDone = reader.readBool(offsets[1]);
  return object;
}
...
extension TodoQueryFilter on QueryBuilder<Todo, Todo, QFilterCondition> {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> taskDoneEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'taskDone',
        value: value,
...
extension TodoQuerySortBy on QueryBuilder<Todo, Todo, QSortBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> sortByTaskDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskDone', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> sortByTaskDoneDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskDone', Sort.desc);
    });
  }
}
...
extension TodoQuerySortThenBy on QueryBuilder<Todo, Todo, QSortThenBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> thenByTaskDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskDone', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> thenByTaskDoneDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskDone', Sort.desc);
    });
  }
...
extension TodoQueryWhereDistinct on QueryBuilder<Todo, Todo, QDistinct> {
  ...
  QueryBuilder<Todo, Todo, QDistinct> distinctByTaskDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'taskDone');
    });
  }
}
...
extension TodoQueryProperty on QueryBuilder<Todo, Todo, QQueryProperty> {
  ...
  QueryBuilder<Todo, bool, QQueryOperations> taskDoneProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'taskDone');
    });
  }
}
